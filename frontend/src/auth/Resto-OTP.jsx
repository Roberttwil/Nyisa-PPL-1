...
const OTP = () => {
  ...
  useEffect(() => {
    ...
    // Menangani timer untuk resend
    if (resendTimer > 0) {
      const timer = setInterval(() => {
        setResendTimer((prev) => prev - 1);
      }, 1000);
      return () => clearInterval(timer); // Membersihkan interval saat komponen unmount atau timer berakhir
    }
  }, [resendTimer]); // Menjalankan efek setiap kali resendTimer berubah
    ...
    <div className="flex flex-wrap justify-center items-center min-h-screen px-4 relative">
      ...
      <div className="w-full max-w-md p-8 text-center bg-[#D6E9A6] rounded-3xl z-10">
        ...
        <p className="text-sm text-green-900 mb-6">
          ...
          enter your 6-digit OTP code to verify your restaurant registration.
        </p>
